SELECT DISTINCT usage_status FROM KAGGLE_SUBSCRIPTION.DBT_PJT.MART_DAILY__LOG;
...
SELECT * FROM KAGGLE_SUBSCRIPTION.DBT_PJT.STG_RAW_RAVENSTACK_FEATURE_USAGE LIMIT 10;
